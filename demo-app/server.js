    ...
    <body>
      <div class="container">
        ...
        <div class="status ${state.breakSelector ? 'broken' : 'normal'}">
          ${state.breakSelector ? '[ERROR] SELECTORS BROKEN (Self-healing should kick in)' : '[SUCCESS] Normal Mode'}
        </div>
      ...
      <script>
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
          ...
          if (username === 'demo' && password === 'password') {
            ...
            showMessage('[FAILED] Invalid credentials', 'error');
          }
        });
 ...
 */
app.post('/api/break-selectors', (req, res) => {
 ...
 */
app.post('/api/restore-selectors', (req, res) => {
...
// Start server
app.listen(PORT, () => {
  console.log('[SUCCESS] Self-Healing Demo Server running on http://localhost:' + PORT);
});
